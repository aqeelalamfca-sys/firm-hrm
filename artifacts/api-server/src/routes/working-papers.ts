...
const createSessionSchema = z.object({
  ...
  yearStartDate: z.string().optional().nullable(),
  yearEndDate: z.string().optional().nullable(),
  reportSigningDate: z.string().optional().nullable(),
  consentLetterDate: z.string().optional().nullable(),
  engagementLetterDate: z.string().optional().nullable(),
  ...
  executionStartDate: z.string().optional().nullable(),
  executionEndDate: z.string().optional().nullable(),
  finalizationStartDate: z.string().optional().nullable(),
  finalizationEndDate: z.string().optional().nullable(),
  reportingDeadline: z.string().optional().nullable(),
  boardApprovalDate: z.string().optional().nullable(),
  mgmtRepLetterDate: z.string().optional().nullable(),
  subsequentEventsEndDate: z.string().optional().nullable(),
  eqcrReviewStartDate: z.string().optional().nullable(),
  eqcrReviewEndDate: z.string().optional().nullable(),
...
router.post("/sessions", requireRoles(...WP_ROLES_WRITE), async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const { clientName, engagementYear, entityType, ntn, strn, registrationNo, periodStart, periodEnd, yearStartDate, yearEndDate, reportSigningDate, consentLetterDate, engagementLetterDate, engagementStartDate, planningStartDate, planningEndDate, executionStartDate, executionEndDate, finalizationStartDate, finalizationEndDate, reportingDeadline, boardApprovalDate, mgmtRepLetterDate, subsequentEventsEndDate, eqcrReviewStartDate, eqcrReviewEndDate, reportingFramework, engagementType, engagementContinuity, industryType, groupAuditFlag, itEnvironmentType, taxStatusFlags, specialConditions, auditFirmName, auditFirmLogo, preparerId, preparerName, preparerIds, preparerNames, reviewerId, reviewerName, approverId, approverName, eqcrId, eqcrName } = parsed.data;
    ...
    const session = await db.transaction(async (tx) => {
      const [created] = await tx.insert(wpSessionsTable).values({
        ...
        periodStart: periodStart || yearStartDate || null,
        periodEnd: periodEnd || yearEndDate || null,
        yearStartDate: yearStartDate || null,
        yearEndDate: yearEndDate || null,
        reportSigningDate: reportSigningDate || null,
        consentLetterDate: consentLetterDate || null,
        engagementLetterDate: engagementLetterDate || null,
        engagementStartDate: engagementStartDate || null,
        planningStartDate: planningStartDate || null,
        planningEndDate: planningEndDate || null,
        executionStartDate: executionStartDate || null,
        executionEndDate: executionEndDate || null,
        finalizationStartDate: finalizationStartDate || null,
        finalizationEndDate: finalizationEndDate || null,
        reportingDeadline: reportingDeadline || null,
        boardApprovalDate: boardApprovalDate || null,
        mgmtRepLetterDate: mgmtRepLetterDate || null,
        subsequentEventsEndDate: subsequentEventsEndDate || null,
        eqcrReviewStartDate: eqcrReviewStartDate || null,
        eqcrReviewEndDate: eqcrReviewEndDate || null,
        reportingFramework,
        engagementType,
