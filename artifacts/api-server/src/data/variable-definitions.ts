...
export const VARIABLE_DEFINITIONS: VariableDefinition[] = [
  ...
  v("entity_legal_form", "Entity & Constitution", "Legal Form", "Legal Form", { dataType: "text", inputMode: "dropdown", dropdownOptionsJson: dd(["Private Limited","Public Limited (Unlisted)","Public Limited (Listed)","GEM Board Company","Single Member","LLP","AOP","Sole Proprietor","Bank / DFI","Islamic Bank / Islamic Window","Modaraba","Leasing Company","Insurance Company","NGO/NPO","Trust","Government Entity","Public Sector Entity","SME","Construction / Real Estate","Branch Office"]), mandatoryFlag: M, aiExtractableFlag: AI, displayOrder: 9 }),
