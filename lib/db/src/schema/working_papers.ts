...
export const wpSessionsTable = pgTable("wp_sessions", {
  ...
  yearEndDate: text("year_end_date"),
  reportSigningDate: text("report_signing_date"),
  consentLetterDate: text("consent_letter_date"),
  engagementLetterDate: text("engagement_letter_date"),
  engagementStartDate: text("engagement_start_date"),
  planningStartDate: text("planning_start_date"),
  planningEndDate: text("planning_end_date"),
  executionStartDate: text("execution_start_date"),
  executionEndDate: text("execution_end_date"),
  finalizationStartDate: text("finalization_start_date"),
  finalizationEndDate: text("finalization_end_date"),
  reportingDeadline: text("reporting_deadline"),
  boardApprovalDate: text("board_approval_date"),
  mgmtRepLetterDate: text("mgmt_rep_letter_date"),
  subsequentEventsEndDate: text("subsequent_events_end_date"),
  eqcrReviewStartDate: text("eqcr_review_start_date"),
  eqcrReviewEndDate: text("eqcr_review_end_date"),
